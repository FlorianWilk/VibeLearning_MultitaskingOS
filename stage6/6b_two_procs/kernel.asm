; ============================================================================
; 6b kernel.asm  --  Preemptiver Scheduler fuer zwei Ring-3-Prozesse
; ----------------------------------------------------------------------------
...
.cs_reloaded:
    ...
    mov eax, [USER_LOAD + 0]               ; entry proc_a
    mov ebx, USTACK_A
    mov edi, KSTACK_A
    call build_kstack
    mov [saved_esp + 0], eax
    ...
    mov eax, [USER_LOAD + 4]               ; entry proc_b
    mov ebx, USTACK_B
    mov edi, KSTACK_B
    call build_kstack
...
; Daten
; ============================================================================
msg_status db '6b: zwei Ring-3-Prozesse, Timer schaltet preemptiv um:', 10, 10, 0
