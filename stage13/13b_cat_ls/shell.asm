...
.loop:
    ...
    mov eax, SYS_READ
    mov ebx, linebuf
    mov ecx, 127                  ; 1 Byte Reserve fuer die 0-Terminierung
    int 0x80
    test eax, eax
    jz .loop
    mov [linelen], eax
    mov byte [linebuf + eax], 0   ; cmdline terminieren (read liefert keine 0;
                                  ; sonst liest copy_name Reste laengerer Befehle)
...
banner   db 'Shell. Befehle: ls, cat <datei>, echo, hello, count, &', 0x0A
